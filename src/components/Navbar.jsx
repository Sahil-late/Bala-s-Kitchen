...
const Navbar = ({ className = '' }) => {
    const {setScroll} = useContext(secContext)
...
">
                    <button onClick={()=> setScroll('Recipies')}  className="text-white rounded-lg relative hover:py-[3.5px] p-1 px-2 hover:bg-[linear-gradient(135deg,_#EA2011,_#EA5110,_#ECE80C)] bg-[rgba(255,255,255,0.3)] shadow-[3px_5px_7px_rgba(0,0,0,0.7)]">
                        Recipies
                    ...
                    <button onClick={()=> setScroll('Information')} className="text-white rounded-lg relative hover:py-[3.5px] p-1 px-2 hover:bg-[linear-gradient(135deg,_#EA2011,_#EA5110,_#ECE80C)] bg-[rgba(255,255,255,0.3)] shadow-[3px_5px_7px_rgba(0,0,0,0.7)]">
                        Information
                        <span className='absolute left-0 top-0 bg-[#EA2011] w-0.5 h-full rounded-full'></span>
